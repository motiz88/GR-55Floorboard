...
void stompbox_mod::setEditPages()
{
  ...
  /*  editDetails()->page()->insertStackField(0, 0, 1, 3, 1);
    ...
    editDetails()->page()->addKnob(0, 3, 1, 1, "02", "00", "15");
    editDetails()->page()->addKnob(0, 1, 1, 1, "02", "00", "16");
    editDetails()->page()->addKnob(0, 2, 1, 1, "02", "00", "17", "normal","right", 105);
    ...
    editDetails()->page()->addKnob(0, 2, 1, 1, "05", "00", "26");
    editDetails()->page()->addKnob(0, 3, 1, 1, "05", "00", "28");;
    editDetails()->page()->addGroupBox(0, 1, 1, 1);

    editDetails()->page()->newGroupBox("Level");
    editDetails()->page()->addKnob(0, 0, 1, 1, "05", "00", "27");
    editDetails()->page()->addGroupBox(0, 2, 1, 1);
