...
#include "../../../grfloorboard/customComboBox.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_customComboBox_t, stringdata) + ofs \
...
const QMetaObject customComboBox::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_customComboBox.data,
...
void *customComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_customComboBox.stringdata))
