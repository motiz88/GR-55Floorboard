...
void soundSource::ch_mode_ButtonSignal(bool value)
{
    if (this->id == 0)
    {
...
void soundSource::distortion_ButtonSignal(bool value)
{
    if (this->id == 1)
    {
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
void soundSource::preamp1_ButtonSignal(bool value)
{
    if (this->id == 2)
    {
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
void soundSource::preamp2_ButtonSignal(bool value)
{
    if (this->id == 3)
    {
      emitValueChanged(this->hex1, this->hex2, "00", "void");
...
void soundSource::setKnob1(QString hex1, QString hex2, QString hex3)
{
        ...
        knob1 = new customDial(0, 0, range, 1, 10, QPoint(10, 15), this, hex1, hex2, hex3);
};
...
void soundSource::setKnob2(QString hex1, QString hex2, QString hex3)
{
        MidiTable *midiTable = MidiTable::Instance();
        int range = midiTable->getRange("Structure", hex1, hex2, hex3);
        knob2 = new customDial(0, 0, range, 1, 10, QPoint(200, 15), this, hex1, hex2, hex3);
};
...
void soundSource::setSwitch(QString hex1, QString hex2, QString hex3)
{
        ...
        switchbutton->move(QPoint(15, 55));
};
...
void soundSource::updateStompPath()
{
        ...
        if (this->id == 1) {this->fxName = tr("Amp/Cabinet");};
